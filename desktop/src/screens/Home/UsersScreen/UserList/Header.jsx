...
const UserListTitle = materialStyled(Typography)({
  color: '#000000',
  fontSize: '1.375rem',
  fontWeight: 500,
  letterSpacing: 1,
...
const Header = ({
  ...
  const ratingsOptions = [{ id: 'vulkan-users', label: t('vulkan-users') }];
  ...
  return (
    <Container {...props}>
      <UserListTitle variant="subtitle2">{t('all-users')}</UserListTitle>
      <SearchBar>
        <SearchInput
          variant="outlined"
          ...
          placeholder={t('search-for-users-countries')}
          startAdornment={
